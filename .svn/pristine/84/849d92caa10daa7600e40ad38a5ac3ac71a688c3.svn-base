...
public class InsertCompanyUserToGroupHandler extends Handler {
	Activity context;
	ViewGroup view;
	LoadingDialog dialog;
	
	public InsertCompanyUserToGroupHandler(Activity context, LoadingDialog dialog) {
		super();
	...
	public void handleMessage(android.os.Message msg) {
		...
		if(b){
	        ...
	        b2.putString("type", "add_group_user");
	        i.putExtras(b2);
