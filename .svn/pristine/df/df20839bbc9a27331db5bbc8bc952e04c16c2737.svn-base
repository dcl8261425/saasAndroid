...
public class WeixinMenuManagerAddHandler extends Handler {
	LoadingDialog sDialog;
	GaiLanMenuUpdateWindowActivity context;
	public WeixinMenuManagerAddHandler(LoadingDialog dialog2, GaiLanMenuUpdateWindowActivity context) {
		super();
