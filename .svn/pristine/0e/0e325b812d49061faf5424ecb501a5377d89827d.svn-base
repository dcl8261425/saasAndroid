...
public class QueryLinkManHandler extends Handler {
	Activity context;
	XListView view;
	...
	public QueryLinkManHandler(Activity context, XListView view,
	...
	public void handleMessage(android.os.Message msg) {
		...
		if(context.findViewById(R.id.crm_query_linkman_nowpage)!=null){
			nowpage=(BootstrapEditText) context.findViewById(R.id.crm_query_linkman_nowpage);
		}else{
			nowpage=(BootstrapEditText) context.findViewById(R.id.crm_grab_linkman_nowpage);
		}
		if(b){
			List<LinkManListDto> weiXinList = (List<LinkManListDto>) map.get("data");
			QueryLinkManAdapter adapter = 
					new QueryLinkManAdapter(context, weiXinList,layout);
