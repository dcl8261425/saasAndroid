 ...
 *
 */
public class WeixinAutoVideoThread extends Thread {
	private Context context;
	private Handler handler;
	public WeixinAutoVideoThread(Context context, Handler handler) {
		super();
	...
	public void run() {
		...
		List<Map<String, Object>> list=qnpAPi.getAutoReSend_Voice();
