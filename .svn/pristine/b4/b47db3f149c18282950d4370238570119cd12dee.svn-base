...
public class AutoResendSetAddItemThread extends Thread {
	private Context context;
	private int type;
	private Handler handler;
	private WeiXinAutoReSendMenuDto dto;
	public AutoResendSetAddItemThread(Context context, int type, Handler handler,WeiXinAutoReSendMenuDto dto) {
		super();
