...
public class UpdateGroupInfoHandler extends Handler {
	CreateGroupWindow context;
	ViewGroup view;
	LoadingDialog dialog;
	
	public UpdateGroupInfoHandler(CreateGroupWindow context, LoadingDialog dialog) {
		super();
	...
	public void handleMessage(android.os.Message msg) {
		...
		if(b){
	        ...
	        b2.putString("type", "update_group_info");
	        i.putExtras(b2);
