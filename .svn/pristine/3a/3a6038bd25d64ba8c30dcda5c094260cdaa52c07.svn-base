...
import com.herotculb.qunhaichat.permission.operation.DeleteRoleToConpanyUserHandler;
import com.herotculb.qunhaichat.permission.operation.DeleteRoleToConpanyUserThread;
import com.herotculb.qunhaichat.widget.LoadingDialog;

public class LookUpRoleByUserAdapter extends BaseAdapter {
	private Activity  context;
	private List<RoleDto> list;
	private String userId;
	
	public LookUpRoleByUserAdapter(Activity context, List<RoleDto> list,
			String userId) {
		super();
			...
			public void onClick(View v) {
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sDialog) {
						...
						dialog.show();
						DeleteRoleToConpanyUserHandler handler = 
								new DeleteRoleToConpanyUserHandler(context, dialog,sDialog,
										userId,String.valueOf(dto.getGroupid()));
						DeleteRoleToConpanyUserThread thread =
								new DeleteRoleToConpanyUserThread(context, String.valueOf(dto.getId()),
										String.valueOf(dto.getGroupid()), userId, handler);
						thread.start();
                    }
                })
                .show();
