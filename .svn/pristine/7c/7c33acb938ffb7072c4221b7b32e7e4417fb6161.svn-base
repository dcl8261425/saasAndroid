...
import com.herotculb.qunhaichat.crm.querychance.AllocationMyCreateChanceHandler;
import com.herotculb.qunhaichat.crm.querychance.AllocationMyCreateChanceThread;
import com.herotculb.qunhaichat.crm.querychance.UpdateMyCreateChanceHandler;
import com.herotculb.qunhaichat.crm.querychance.UpdateMyCreateChanceThread;
		...
		if(idstr!=null&&!idstr.equals("")){
			...
			if(type.equals("update")){
				enter.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						// TODO 更新
						LoadingDialog dialog = new LoadingDialog(CreateChanceWindow.this,"正在更新数据！");
						dialog.show();
						UpdateMyCreateChanceHandler handler = 
								new UpdateMyCreateChanceHandler(CreateChanceWindow.this, dialog);
						UpdateMyCreateChanceThread thread = 
								new UpdateMyCreateChanceThread(CreateChanceWindow.this, handler);
						thread.start();
					}
				});
				...
				enter.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						// TODO 指定
						LoadingDialog dialog = new LoadingDialog(CreateChanceWindow.this,"正在确定指定！");
						dialog.show();
						AllocationMyCreateChanceHandler handler = 
								new AllocationMyCreateChanceHandler(CreateChanceWindow.this, dialog);
						AllocationMyCreateChanceThread thread = 
								new AllocationMyCreateChanceThread(CreateChanceWindow.this, handler);
						thread.start();
					}
				});
			}
