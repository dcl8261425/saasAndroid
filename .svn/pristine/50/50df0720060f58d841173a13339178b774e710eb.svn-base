...
public class DeleteRoleHandler extends Handler {
	Activity context;
	ViewGroup view;
	LoadingDialog dialog;
	SweetAlertDialog dialog2;
	
	public DeleteRoleHandler(Activity context,
	...
	public void handleMessage(android.os.Message msg) {
		...
		dialog.hide();
		dialog.dismiss();
		BootstrapButton b0 = (BootstrapButton)context.findViewById(R.id.permission_lookup_role_name_query);
    	b0.performClick();
