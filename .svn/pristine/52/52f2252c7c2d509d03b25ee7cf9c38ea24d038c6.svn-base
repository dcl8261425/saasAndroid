 ...
 * 
 */
public class SignRegisterActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mLoginBtn = (Button)findViewById(R.id.login_register);
		typeBtn = (Button)findViewById(R.id.register_conpany_type_btn);
		...
		typeBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO 选择行业
				Intent i = new Intent(SignRegisterActivity.this,GetHangyeWindow.class);
				Bundle b = new Bundle();
				i.putExtras(b);
				SignRegisterActivity.this.startActivityForResult(i, 0);
//				SignRegisterActivity.this.finish();
			}
		});
		...
		mLoginBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO 跳转到登录页面
				Intent i = new Intent(SignRegisterActivity.this,SignInActivity.class);
				Bundle b = new Bundle();
				i.putExtras(b);
				SignRegisterActivity.this.startActivity(i);
				SignRegisterActivity.this.finish();
			}
		});
	...
	{
		province_spinner = (Spinner) findViewById(R.id.register_province_spinner);
    	...
    	{	
			...
			{					
				...
				city_spinner = (Spinner) findViewById(R.id.register_city_spinner);
				if(true)
				{	
					Log.v("test", "province: "+province_spinner.getSelectedItem().toString()+provinceId.toString());
					county_spinner = (Spinner) findViewById(R.id.register_county_spinner);
					city_spinner = (Spinner) findViewById(R.id.register_city_spinner);
	...
	//弹出框返回的内容在这里接受
	 protected void onActivityResult(int requestCode, int resultCode, Intent data) {  
	        ...
	        if(type.equals("check_hangye")){
	        	Log.e("hangye_name--", bundle.getString("hangyeName"));
	        	EditText id = (EditText)findViewById(R.id.register_conpany_type_id);
	        	EditText hangyeName = (EditText)findViewById(R.id.register_conpany_type);
	        	id.setText(bundle.getString("id"));
	        	hangyeName.setText(bundle.getString("hangyeName"));
	        }
	 }
