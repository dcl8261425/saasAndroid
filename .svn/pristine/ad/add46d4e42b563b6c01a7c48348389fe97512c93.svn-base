...
public class GoodsDeleteSourceLinkManHandler extends Handler {
	Activity context;
	ViewGroup view;
	LoadingDialog dialog;
	SweetAlertDialog dialog2;
	
	public GoodsDeleteSourceLinkManHandler(Activity context,
	...
	public void handleMessage(android.os.Message msg) {
		...
		dialog.hide();
		dialog.dismiss();
		BootstrapButton b0 = (BootstrapButton)context.findViewById(R.id.goods_source_linkman_name_query);
    	b0.performClick();
