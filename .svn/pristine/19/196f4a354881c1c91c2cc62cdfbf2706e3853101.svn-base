...
public class WeixinSetDaZhuanPanNumHandler extends Handler {
	Activity context;
	ViewGroup view;
	LoadingDialog dialog;
	
	public WeixinSetDaZhuanPanNumHandler(Activity context, LoadingDialog dialog) {
		super();
	...
	public void handleMessage(android.os.Message msg) {
		...
		if(b){
			...
			b0.performClick();
			new SweetAlertDialog(context, SweetAlertDialog.SUCCESS_TYPE).setTitleText("设定次数")
