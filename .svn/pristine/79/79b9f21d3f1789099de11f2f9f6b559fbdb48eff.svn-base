			...
			if(typestr!=WeiXinAutoReSendMenuDto.TYPE_EVENT){
				enter.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						dialog.show();
						AutoResendSetUpdateHandler ah=new AutoResendSetUpdateHandler(AutoResendSetWindow.this, typestr, dialog);
						AutoResendSetUpdateThread at=new AutoResendSetUpdateThread(AutoResendSetWindow.this,typestr, ah, dto);
						at.start();
					}
				});
			}else{
