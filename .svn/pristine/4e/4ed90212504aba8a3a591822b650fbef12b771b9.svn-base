 ...
 *
 */
public class WeixinAutoLocationThread extends Thread {
	private Context context;
	private Handler handler;
	public WeixinAutoLocationThread(Context context, Handler handler) {
		super();
	...
	public void run() {
		...
		List<Map<String, Object>> list=qnpAPi.getAutoReSend_Location();
