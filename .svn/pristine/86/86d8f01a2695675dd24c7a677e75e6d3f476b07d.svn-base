...
public class UpdateMyCreateChanceThread extends Thread {
	private Activity context;
	private Handler handler;
	
	public UpdateMyCreateChanceThread(Activity context, 
			Handler handler) {
		super();
	...
	public void run() {
		...
		List<Map<String, Object>> list=qnpAPi.updateMyCreateChance(CustomerName, CustomerAddress,
				CustomerType, CustomerLevel, CustomerMark, CreateManMark, NotesUserId,
				State, ChanceId);
