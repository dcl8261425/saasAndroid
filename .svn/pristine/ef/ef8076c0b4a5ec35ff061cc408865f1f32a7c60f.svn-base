...
public class DeleteGroupHandler extends Handler {
	Activity context;
	ViewGroup view;
	LoadingDialog dialog;
	SweetAlertDialog dialog2;
	
	public DeleteGroupHandler(Activity context, LoadingDialog dialog,
			SweetAlertDialog dialog2) {
		super();
	...
	public void handleMessage(android.os.Message msg) {
		...
		dialog.hide();
		dialog.dismiss();
		BootstrapButton b0 = (BootstrapButton)context.findViewById(R.id.get_all_group_name_query);
    	b0.performClick();
