 ...
 *
 */
public class WeixinAutoLinkThread extends Thread {
	private Context context;
	private Handler handler;
	public WeixinAutoLinkThread(Context context, Handler handler) {
		super();
	...
	public void run() {
		...
		List<Map<String, Object>> list=qnpAPi.getAutoReSend_Link();
