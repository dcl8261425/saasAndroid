...
public class GetGroupCompanyUserWindow extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GetGroupCompanyUserHandler handler = 
				new GetGroupCompanyUserHandler(GetGroupCompanyUserWindow.this, list, dialog2, classes,groupIdStr,R.layout.user_company_group_list);
		GetGroupCompanyUserThread thread = 
				new GetGroupCompanyUserThread(GetGroupCompanyUserWindow.this,"1","50","", handler);
		thread.start();
		...
		query.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				GetGroupCompanyUserHandler handler = 
						new GetGroupCompanyUserHandler(GetGroupCompanyUserWindow.this, list, dialog, classes,groupIdStr,R.layout.user_company_group_list);
				GetGroupCompanyUserThread thread = 
						new GetGroupCompanyUserThread(GetGroupCompanyUserWindow.this,"1","50",namestr, handler);
				thread.start();
			}
		});
