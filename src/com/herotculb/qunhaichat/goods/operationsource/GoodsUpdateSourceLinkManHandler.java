...
public class GoodsUpdateSourceLinkManHandler extends Handler {
	GoodsAddSourceLinkManWindow context;
	ViewGroup view;
	LoadingDialog dialog;
	
	public GoodsUpdateSourceLinkManHandler(GoodsAddSourceLinkManWindow context, LoadingDialog dialog) {
		super();
