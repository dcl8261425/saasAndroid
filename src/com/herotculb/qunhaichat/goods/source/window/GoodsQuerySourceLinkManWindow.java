...
public class GoodsQuerySourceLinkManWindow extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		layout = R.layout.goods_source_get_linkman_list;
		...
		list.setXListViewListener(new IXListViewListener() {
			...
			public void onRefresh() {
				...
				GoodsQuerySourceLinkManHandler handler = 
						new GoodsQuerySourceLinkManHandler(GoodsQuerySourceLinkManWindow.this, view, dialog,layout);
		...
		GoodsQuerySourceLinkManHandler handler = 
				new GoodsQuerySourceLinkManHandler(GoodsQuerySourceLinkManWindow.this, list, dialog,layout);
		GoodsQuerySourceLinkManThread thread = 
		...
		query.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				dialog.show();
				XListView view=(XListView) GoodsQuerySourceLinkManWindow.this.findViewById(R.id.goods_source_linkman_list);
				GoodsQuerySourceLinkManHandler handler=new GoodsQuerySourceLinkManHandler(GoodsQuerySourceLinkManWindow.this,view,dialog,layout);
		...
		BootstrapButton cancle=(BootstrapButton) GoodsQuerySourceLinkManWindow.this.findViewById(R.id.goods_source_linkman_name_cancle);
		cancle.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				// TODO 取消
				GoodsQuerySourceLinkManWindow.this.finish();
			}
		});
