...
public class WeixinAddPriceUserHandler extends Handler {
	VipUpdateWindowActivity context;
	ViewGroup view;
	LoadingDialog dialog;
	
	public WeixinAddPriceUserHandler(VipUpdateWindowActivity context, LoadingDialog dialog) {
		super();
	...
	public void handleMessage(android.os.Message msg) {
		...
		if(b){
	        ...
	        b2.putString("type", "add_price_user");
	        i.putExtras(b2);
