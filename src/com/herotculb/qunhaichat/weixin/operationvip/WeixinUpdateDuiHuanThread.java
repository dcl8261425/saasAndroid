...
public class WeixinUpdateDuiHuanThread extends Thread {
	private Activity context;
	private Handler handler;
	
	public WeixinUpdateDuiHuanThread(Activity context, Handler handler) {
		super();
	...
	public void run() {
		...
		List<Map<String, Object>> list=qnpAPi.updateScoreDuiHuan(id, name, score, marks, image, num);
