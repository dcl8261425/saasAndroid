 ...
 *
 */
public class WeixinAutoVoiceThread extends Thread {
	private Context context;
	private Handler handler;
	public WeixinAutoVoiceThread(Context context, Handler handler) {
		super();
	...
	public void run() {
		...
		List<Map<String, Object>> list=qnpAPi.getAutoReSend_Video();
