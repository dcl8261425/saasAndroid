 ...
 *
 */
public class WeixinAutoImageThread extends Thread {
	private Context context;
	private Handler handler;
	public WeixinAutoImageThread(Context context, Handler handler) {
		super();
	...
	public void run() {
		...
		List<Map<String, Object>> list=qnpAPi.getAutoReSend_Image();
