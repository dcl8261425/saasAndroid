...
public class AutoResourceAdapter extends BaseAdapter {
	...
	public AutoResourceAdapter(Activity context,List<WeiXinReSendDto> list){
		...
		update.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				case WeiXinReSendDto.IMAGE:
	                ...
	                i1.putExtras(b1);  
	                context.startActivityForResult(i1, 0);  
	                context.overridePendingTransition(R.anim.modal_in, R.anim.modal_out);
					break;
				case WeiXinReSendDto.IMAGE_TEXT:
	                ...
	                i2.putExtras(b2);  
	                context.startActivityForResult(i2, 0);  
	                context.overridePendingTransition(R.anim.modal_in, R.anim.modal_out);
					break;
				case WeiXinReSendDto.MUSIC:
	                ...
	                i3.putExtras(b3);  
	                context.startActivityForResult(i3, 0);  
	                context.overridePendingTransition(R.anim.modal_in, R.anim.modal_out);
					break;
				...
				case WeiXinReSendDto.VOICE:
	                ...
	                i5.putExtras(b5);  
	                context.startActivityForResult(i5, 0);  
	                context.overridePendingTransition(R.anim.modal_in, R.anim.modal_out);
					break;
				default:
					break;
