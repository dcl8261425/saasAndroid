...
public class ImageResourceWindow extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			enter.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					LoadingDialog dialog2 = new LoadingDialog(
							ImageResourceWindow.this, "正在获取数据");
					dialog2.show();
					AutoResendUpdateHandler handler = new AutoResendUpdateHandler(ImageResourceWindow.this,WeiXinReSendDto.IMAGE,dialog2);
					AutoResendUpdateThread thread = new AutoResendUpdateThread(ImageResourceWindow.this , handler, WeiXinReSendDto.IMAGE);
					thread.start();
				}
			});
		}else{
			enter.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					LoadingDialog dialog2 = new LoadingDialog(
							ImageResourceWindow.this, "正在获取数据");
					dialog2.show();
					AutoResendAddHandler handler = new AutoResendAddHandler(ImageResourceWindow.this,WeiXinReSendDto.IMAGE,dialog2);
					AutoResendAddThread thread = new AutoResendAddThread(ImageResourceWindow.this , handler, WeiXinReSendDto.IMAGE);
					thread.start();
				}
			});
		}
		...
		cencal.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent( ImageResourceWindow.this, HomeActivity.class);  
		        Bundle b = new Bundle();
		        b.putString("type", "cancel");
		        i.putExtras(b);
		        ImageResourceWindow.this.setResult( ImageResourceWindow.this.RESULT_OK, i);  
