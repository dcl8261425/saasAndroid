...
public class QueryToMyChanceHandler extends Handler {
	Activity context;
	XListView view;
	...
	public QueryToMyChanceHandler(Activity context, XListView view,
	...
	public void handleMessage(android.os.Message msg) {
		...
		if(context.findViewById(R.id.crm_query_my_chance_nowpage)!=null){
			...
			nowpage=(BootstrapEditText) context.findViewById(R.id.crm_selected_to_my_chance_nowpage);
		}
		if(b){
			List<ChanceListDto> weiXinList = (List<ChanceListDto>) map.get("data");
			QueryToMyChanceAdapter adapter = new QueryToMyChanceAdapter(context, weiXinList,layout);
