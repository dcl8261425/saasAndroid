...
public class QueryMyCustomerHandler extends Handler {
	HomeActivity context;
	XListView view;
	LoadingDialog dialog;
	View viewp;
		
	public QueryMyCustomerHandler(HomeActivity context, XListView view,
			LoadingDialog dialog) {
		super();
	...
	public void handleMessage(android.os.Message msg) {
		...
		if(b){
			...
			QueryMyCustomerAdapter adapter = 
					new QueryMyCustomerAdapter(context, weiXinList);
